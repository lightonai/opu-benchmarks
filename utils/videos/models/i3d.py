"""
Taken from here:
https://github.com/yaohungt/Gated-Spatio-Temporal-Energy-Graph/blob/master/models/i3d.py
"""
...
class InceptionI3d(nn.Module):
    ...
    def __init__(self, num_classes=400, spatial_squeeze=True, only_feat=True,
    ...
    def forward(self, x):
        ...
        if logits.dim() == 3 and self._final_endpoint == "Logits":
